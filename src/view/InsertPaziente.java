...
public class InsertPaziente extends JInternalFrame {
	...
	private void drawGUI() {
		...
		setFrameIcon(new ImageIcon(
				InsertPaziente.class
						.getResource("/icons/profilo_utente_24.png")));
		setTitle("Creazione NUOVO Paziente");
		...
		imgCheckNickName.setVisible(false);
		imgCheckNickName.setIcon(new ImageIcon(InsertPaziente.class
