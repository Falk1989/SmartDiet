...
public class PrimaVisita extends JInternalFrame {
	...
	public PrimaVisita() {
		...
		setTitle("Inserimento guidato Visita Paziente");
		setBounds(100, 100, 1068, 527);
		...
		btnConfermaESalva.setEnabled(false);
		...
		labelData.setFont(new Font("Microsoft JhengHei UI Light", Font.PLAIN,
				16));
		labelData.setBounds(36, 131, 120, 33);
		...
		nameText.setBounds(113, 47, 319, 22);
		...
		comboAnno.setModel(new DefaultComboBoxModel(new String[] { "1950",
				...
				"2079", "2080" }));
		comboAnno.setBounds(446, 132, 65, 30);
		...
		lblDataVisita.setFont(new Font("Microsoft JhengHei UI Light",
				Font.PLAIN, 16));
		lblDataVisita.setBounds(512, 216, 100, 30);
		tabGeneralit‡Clinica.add(lblDataVisita);

		dataVisitaText.setBounds(624, 220, 105, 22);
		...
		panelCredenziali.setBounds(39, 305, 728, 124);
		tabGeneralit‡Clinica.add(panelCredenziali);
		...
		lblNickname.setBounds(145, 23, 107, 34);
		...
		mailLabel.setFont(new Font("Microsoft YaHei UI Light", Font.PLAIN, 16));
		mailLabel.setBounds(36, 254, 65, 38);
		tabGeneralit‡Clinica.add(mailLabel);
		
		mailtextField = new JTextField();
		mailtextField.setToolTipText("Et\u00E0");
		mailtextField.setColumns(10);
		mailtextField.setBounds(113, 263, 319, 22);
		tabGeneralit‡Clinica.add(mailtextField);
		...
		panelBotton.setBorder(new TitledBorder(null, "Tipologia Visita", TitledBorder.CENTER, TitledBorder.TOP, null, Color.BLUE));
		panelBotton.setBounds(10, 11, 188, 141);
		getContentPane().add(panelBotton);
		panelBotton.setLayout(null);

		btnPrimaVisita = new JButton("Prima");
		btnPrimaVisita.setBounds(13, 38, 162, 41);
		panelBotton.add(btnPrimaVisita);
		btnPrimaVisita.setIcon(new ImageIcon(PrimaVisita.class.getResource("/icons/iud_insert_tipo1_32.png")));
		btnPrimaVisita.setFont(new Font("Microsoft JhengHei UI Light", Font.BOLD, 16));

		btnSuccessiveVisite = new JButton("Successive");
		btnSuccessiveVisite.setIcon(new ImageIcon(PrimaVisita.class.getResource("/icons/maschera_std_32.png")));
		btnSuccessiveVisite.setFont(new Font("Microsoft JhengHei UI Light", Font.BOLD, 16));
		btnSuccessiveVisite.setBounds(13, 90, 162, 41);
		panelBotton.add(btnSuccessiveVisite);

		// BOTTONE
		// CONFERMA-----------------------------------------------------------------------------------------------------------------
		btnConfermaESalva.setFont(new Font("Microsoft JhengHei UI Light", Font.BOLD, 16));
		btnConfermaESalva.setBounds(10, 443, 188, 40);
		getContentPane().add(btnConfermaESalva);

		JPanel panelPaziente = new JPanel();
		panelPaziente.setBorder(new TitledBorder(null, "Paziente", TitledBorder.CENTER, TitledBorder.TOP, null, Color.BLUE));
		panelPaziente.setBounds(10, 163, 189, 73);
		getContentPane().add(panelPaziente);
		...
		btnSuccessiveVisite.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				btnPrimaVisita.setEnabled(false);
				btnSuccessiveVisite.setEnabled(false);
				comboPazienti.setEnabled(true);

				// popola il combo pazienti del dottore loggato
			}
		});
		...
		mailtextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent arg0) {
					...
					if (!(mailtextField.getText().equals(""))) // se non Ë vuoto il
															// campo nickname
					{
						if (dbInterface.verifyNickName(mailtextField.getText())) // se
																				// il
																				// nickname
																				// Ë
																				// gi‡
																				// presente
						{
							...
							desktopWindow
									.getAllertWindow()
									.aggiungiMessaggio(
											"NickName gi‡ in uso da un altro utente!!! \nOptare per una scelta di differente...");
							desktopWindow.getAllertWindow().setVisible(true);
							CFText.requestFocus();
						} else {
							fieldNickName.setText(mailtextField.getText());
							fieldPassword
	...
	public JButton getBtnPrimaVisita() {
		return btnPrimaVisita;
	}


	public JButton getBtnSuccessiveVisite() {
		return btnSuccessiveVisite;
	}
